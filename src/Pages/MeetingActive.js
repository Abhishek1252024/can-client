      ...
      <div className='flex flex-col w-full h-screen px-10 bg-[#FFF6FB]'>
        ...
        <div className=' flex flex-row py-6 justify-end w-full'>
          <div className='flex flex-row gap-4 justify-center items-center [w-60%]'>
            <button className={`flex justify-center items-center p-2 bg-[#00000020] w-[45px] h-[45px] rounded-[20px] hover:bg-[#C31A7F] hover:shadow-lg`} onClick={handleMic}>      {micOn ? <img src={micOpen} alt="Mic On" /> : <img src={microphone} alt="Mic Off" />}</button>
            <button className='flex justify-center items-center p-2 bg-[#00000020] w-[45px] h-[45px] rounded-[20px] hover:bg-[#C31A7F] hover:shadow-lg'><img src={video} alt="Video" /></button>
            <button className='flex justify-center items-center p-2 bg-[#00000020] w-[45px] h-[45px] rounded-[20px] hover:bg-[#C31A7F] hover:shadow-lg'><img src={sharescreen} alt="Share Screen" /></button>
            <button className='flex justify-center items-center p-2 bg-[#00000020] w-[45px] h-[45px] rounded-[20px] hover:bg-[#C31A7F] hover:shadow-lg'><img src={hand} alt="Hand" /></button>
            <button className='flex justify-center items-center p-2 bg-[#00000020] w-[45px] h-[45px] rounded-[20px] hover:bg-[#C31A7F] hover:shadow-lg'><img src={emotions} alt="Emotions" /></button>
          ...
          <div className='flex w-[40%] justify-end'>
            ...
            <div className='flex flex-row gap-4 pr-2'>
              <button className='flex justify-center items-center p-2 bg-[#00000020] w-[45px] h-[45px] rounded-[20px] hover:bg-[#C31A7F] hover:shadow-lg'><img src={profile} alt="Profile" /></button>
              <button className='flex justify-center items-center p-2 bg-[#00000020] w-[45px] h-[45px] rounded-[20px] hover:bg-[#C31A7F] hover:shadow-lg'><img src={message} alt="Message" /></button>
            </div>
          </div>
