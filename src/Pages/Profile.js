            ...
            <div className='h-[100vh] '>
                ...
                <div className='bg-[#FEF8FD] flex flex-col'>
                    ...
                    <div className='h-[100%]  flex lg:items-center'>
                        <div className=' md:w-[360px] lg:w-[301px]  sm:w-[330px]  bg-[#fff]    backdrop-blur-md rounded-[20px]' style={{
                            ...
                            <div className='p-4 mx-4 mt-3 lg:text-[14px]  text-[14px] font-semibold text-center'>
                                <h1 className='spce-1 '>You can add the profile of your <br />  Caregiver byclicking on the Add profile button.</h1>
                            </div>
                            <div className='h-[60%] w-[100%] pb-5 px-[10%]   flex justify-between  relative'>
                                <div  className='w-[49%] h-[40%] pb-3  bg-[#FEE5EA] rounded-3xl flex flex-col justify-center items-center cursor-pointer ' style={{ boxShadow: '0px 10px 30px rgba(0, 0, 0, 0.05)' }}>
